...
import AbstractUserInterface, { uiScaleFactor } from "../UserInterface";
...
import PlayerProfile from "../Components/Native/PlayerProfile";
import Collidable from "../Extensions/ExtensionCollidable";
import { DynamicLayoutable } from "../Extensions/ExtensionDynamicLayoutable";
...
import { networking, ws, cameraController, deltaTime } from "../../../../Main";
import { DARKEND_BASE } from "../../../../../Shared/Utils/Color";
import { Rarity } from "../../../../../Shared/Entity/Statics/EntityRarity";
import { MOB_TYPES, PETAL_TYPES, PetalType } from "../../../../../Shared/Entity/Statics/EntityType";
...
let backgroundEntities: Set<Mob> = new Set();
...
export default class UserInterfaceTitle extends AbstractUserInterface {
...

        {
            ...
            this.squadMenuContainer = this.createAddableContainer(
                ...
                [
                    ...
                    new StaticText(
                        () => ({
                            x: this.waveRoomVisible === WaveRoomVisibleState.Private ? 103 : 117,
                            y: 24 + 8,
                            w: 0,
                            h: 0,
                        }),
