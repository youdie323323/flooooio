import { ComponentExtensionTemplate, ExtensionConstructor, UpdateFunction } from "./Extension";
 ...
 */
export function DynamicLayoutable<T extends ExtensionConstructor>(Base: T) {
