import type { AdditionalClientboundListen } from "./Packet/Bound/Client/PacketClientbound";
import PacketClientbound from "./Packet/Bound/Client/PacketClientbound";
import PacketServerbound from "./Packet/Bound/Server/PacketServerbound";
...
export default class ClientWebsocket {
    ...
    constructor(
        additionalClientboundListen: AdditionalClientboundListen = {},
    ) {
        this.socket = null;
