...
pub fn save(self: *CanvasContext) void {
    @"4"(self.id);
...
pub fn restore(self: *CanvasContext) void {
    @"5"(self.id);
...
pub fn resetTransform(self: *const CanvasContext) void {
    @"6"(self.id);
}

pub fn setTransform(self: *const CanvasContext, m11: f32, m12: f32, m21: f32, m22: f32, dx: f32, dy: f32) void {
    @"7"(self.id, m11, m12, m21, m22, dx, dy);
}

pub fn beginPath(self: *const CanvasContext) void {
    @"14"(self.id);
}

pub fn fill(self: *const CanvasContext) void {
    @"8"(self.id);
}

pub fn fillPath(self: *const CanvasContext, path: Path2D, comptime winding: FillType) void {
    @"9"(self.id, path.id, comptime @intFromBool(winding == .nonzero));
}

pub fn stroke(self: *const CanvasContext) void {
    @"10"(self.id);
}

pub fn strokePath(self: *const CanvasContext, path: Path2D) void {
    @"11"(self.id, path.id);
}

pub fn clip(self: *const CanvasContext) void {
    @"12"(self.id);
}

pub fn clipPath(self: *const CanvasContext, path: Path2D) void {
    @"13"(self.id, path.id);
}

pub fn rect(self: *const CanvasContext, x: f32, y: f32, width: f32, height: f32) void {
    @"16"(self.id, x, y, width, height);
}

pub fn fillRect(self: *const CanvasContext, x: f32, y: f32, width: f32, height: f32) void {
    @"66"(self.id, x, y, width, height);
}

pub fn clearRect(self: *const CanvasContext, x: f32, y: f32, width: f32, height: f32) void {
    @"18"(self.id, x, y, width, height);
}

pub fn fillPixel(self: *const CanvasContext) void {
    @"19"(self.id);
}

pub fn strokeRect(self: *const CanvasContext, width: f32, height: f32) void {
    @"20"(self.id, width, height);
}

pub fn translate(self: *const CanvasContext, x: f32, y: f32) void {
    @"26"(self.id, x, y);
}

pub fn scale(self: *const CanvasContext, x: f32, y: f32) void {
    @"27"(self.id, x, y);
}

pub fn rotate(self: *const CanvasContext, angle: f32) void {
    @"28"(self.id, angle);
}
...
pub fn strokeText(self: *const CanvasContext, text: []const u8, x: f32, y: f32) void {
    @"38"(self.id, text.ptr, text.len, x, y);
}

// Begin utilities

pub fn drawSvg(self: *const CanvasContext, svg: []const u8) void {
    @"2"(self.id, svg.ptr, svg.len);
}

pub fn clearContextRect(self: *const CanvasContext) void {
    @"17"(self.id);
}
...
pub fn requestAnimationFrame(callback: RAFCallback) u32 {
    return @"65"(callback);
}
