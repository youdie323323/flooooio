//! Provides basic timer operations.
...
pub fn setInterval(handler: TimerHandler, delay: f32) TimerId {
    return @"0"(handler, delay);
}

pub fn setTimeout(handler: TimerHandler, delay: f32) TimerId {
    return @"1"(handler, delay);
}

pub fn clearInterval(id: TimerId) void {
    @"2"(id);
}

pub fn clearTimeout(id: TimerId) void {
    @"3"(id);
}
