...
pub inline fn writeCString(stream: *Writer, str: []const u8) !void {
...
pub inline fn send(self: *const Serverbound, buf: []const u8) !void {
...
pub fn sendWaveChangeMood(self: *const Serverbound, set: pmood.MoodBitSet) !void {
