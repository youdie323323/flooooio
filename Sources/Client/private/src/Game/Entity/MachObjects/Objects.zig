...
pub fn Objects(comptime Object: type, comptime search_field: meta.FieldEnum(Object)) type {
    ...
    return struct {
        ...
        pub inline fn init(objs: *@This(), allocator: mem.Allocator) void {
            objs.internal = .{
                .allocator = allocator,
            };
        }
        ...
        pub inline fn tryLock(objs: *@This()) bool {
        ...
        pub inline fn lock(objs: *@This()) void {
        ...
        pub inline fn unlock(objs: *@This()) void {
