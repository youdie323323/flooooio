...
pub const CanvasContext = extern struct {
    id: u16 = @import("std").mem.zeroes(u16),
};
pub extern fn parseSvg(svgText: [*c]const u8, ctx: [*c]CanvasContext) void;
...
pub const _LIBCPP_OBJECT_FORMAT_WASM = @as(c_int, 1);
...
// C:\Users\kouki\AppData\Roaming\VSCodium\User\globalStorage\ziglang.vscode-zig\zig\x86_64-windows-0.14.1\lib\libcxx\include/__configuration/abi.h:132:9
