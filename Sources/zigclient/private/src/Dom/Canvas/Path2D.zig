...
extern "0" fn @"56"(path_id: PathId) void;
/// Creates a new Path2D object and returns its ID.
extern "0" fn @"57"() PathId;
/// Performs moveTo on path.
extern "0" fn @"58"(path_id: PathId, x: f32, y: f32) void;
/// Performs lineTo on path.
extern "0" fn @"59"(path_id: PathId, x: f32, y: f32) void;
/// Performs quadraticCurveTo on path.
extern "0" fn @"60"(path_id: PathId, cpx: f32, cpy: f32, x: f32, y: f32) void;
/// Performs bezierCurveTo on path.
extern "0" fn @"61"(path_id: PathId, cp1x: f32, cp1y: f32, cp2x: f32, cp2y: f32, x: f32, y: f32) void;
/// Performs closePath on path.
extern "0" fn @"62"(path_id: PathId) void;