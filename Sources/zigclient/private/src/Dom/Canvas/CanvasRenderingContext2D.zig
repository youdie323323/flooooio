...
pub inline fn fillPath(self: CanvasRenderingContext2D, path: Path2D, comptime is_non_zero: bool) void {
    @"16"(self.id, path.id, is_non_zero);
}
...
pub inline fn arc(self: CanvasRenderingContext2D, x: f64, y: f64, radius: f64, startAngle: f64, endAngle: f64, counterclockwise: bool) void {
    @"25"(self.id, x, y, radius, startAngle, endAngle, counterclockwise);
}
...
pub inline fn strokeRect(self: CanvasRenderingContext2D, x: f64, y: f64, width: f64, height: f64) void {
    @"29"(self.id, x, y, width, height);
}

pub inline fn textAlign(self: CanvasRenderingContext2D, a: []const u8) void {
    @"30"(self.id, a.ptr, a.len);
}

pub inline fn textBaseline(self: CanvasRenderingContext2D, baseline: []const u8) void {
    @"31"(self.id, baseline.ptr, baseline.len);
}

pub inline fn bezierCurveTo(self: CanvasRenderingContext2D, cp1x: f64, cp1y: f64, cp2x: f64, cp2y: f64, x: f64, y: f64) void {
    @"32"(self.id, cp1x, cp1y, cp2x, cp2y, x, y);
}

pub inline fn quadraticCurveTo(self: CanvasRenderingContext2D, cpx: f64, cpy: f64, x: f64, y: f64) void {
    @"33"(self.id, cpx, cpy, x, y);
}

pub inline fn drawImage1(self: CanvasRenderingContext2D, src_context: CanvasRenderingContext2D, dx: f64, dy: f64) void {
    @"34"(self.id, src_context.id, dx, dy);
}

pub inline fn drawImage2(self: CanvasRenderingContext2D, src_context: CanvasRenderingContext2D, dx: f64, dy: f64, d_width: f64, d_height: f64) void {
    @"35"(self.id, src_context.id, dx, dy, d_width, d_height);
}
...
extern "0" fn @"2"(pointer: [*]const u8, length: u32, width: f64, height: f64) ContextId;
...
extern "0" fn @"6"(context_id: ContextId, x: f64, y: f64) void;
/// Performs rotate on context.
extern "0" fn @"7"(context_id: ContextId, angle: f64) void;
/// Performs beginPath on context.
extern "0" fn @"8"(context_id: ContextId) void;
/// Performs closePath on context.
extern "0" fn @"9"(context_id: ContextId) void;
/// Performs moveTo on context.
extern "0" fn @"10"(context_id: ContextId, x: f64, y: f64) void;
/// Performs lineTo on context.
extern "0" fn @"11"(context_id: ContextId, x: f64, y: f64) void;
/// Sets font to context.
extern "0" fn @"12"(context_id: ContextId, pointer: [*]const u8, length: u32) void;
/// Performs fillStyle on context.
extern "0" fn @"13"(context_id: ContextId, pointer: [*]const u8, length: u32) void;
/// Performs fillText on context.
extern "0" fn @"14"(context_id: ContextId, pointer: [*]const u8, length: u32, x: f64, y: f64) void;
/// Performs fill on context.
extern "0" fn @"15"(context_id: ContextId) void;
/// Performs path fill on context.
extern "0" fn @"16"(context_id: ContextId, path_id: Path2D.PathId, is_non_zero: bool) void;
/// Performs stroke on context.
extern "0" fn @"17"(context_id: ContextId) void;
/// Performs path stroke on context.
extern "0" fn @"18"(context_id: ContextId, path_id: Path2D.PathId) void;
/// Performs clip on context.
extern "0" fn @"19"(context_id: ContextId) void;
/// Performs path clip on context.
extern "0" fn @"20"(context_id: ContextId, path_id: Path2D.PathId) void;
/// Sets lineWidth to context.
extern "0" fn @"21"(context_id: ContextId, width: f64) void;
/// Sets lineCap to context.
extern "0" fn @"22"(context_id: ContextId, pointer: [*]const u8, length: u32) void;
/// Sets strokeStyle to context.
extern "0" fn @"23"(context_id: ContextId, pointer: [*]const u8, length: u32) void;
/// Sets strokeText to context.
extern "0" fn @"24"(context_id: ContextId, pointer: [*]const u8, length: u32, x: f64, y: f64) void;
/// Performs arc on context.
extern "0" fn @"25"(context_id: ContextId, x: f64, y: f64, radius: f64, startAngle: f64, endAngle: f64, counterclockwise: bool) void;
...
extern "0" fn @"29"(context_id: ContextId, x: f64, y: f64, width: f64, height: f64) void;
...
extern "0" fn @"31"(context_id: ContextId, pointer: [*]const u8, length: u32) void;
/// Performs bezierCurveTo on context.
extern "0" fn @"32"(context_id: ContextId, cp1x: f64, cp1y: f64, cp2x: f64, cp2y: f64, x: f64, y: f64) void;
/// Performs quadraticCurveTo on context.
extern "0" fn @"33"(context_id: ContextId, cpx: f64, cpy: f64, x: f64, y: f64) void;
/// Performs drawImage (overload 1) on context.
extern "0" fn @"34"(dst_context_id: ContextId, src_context_id: ContextId, dx: f64, dy: f64) void;
/// Performs drawImage (overload 2) on context.
extern "0" fn @"35"(dst_context_id: ContextId, src_context_id: ContextId, dx: f64, dy: f64, d_width: f64, d_height: f64) void;

// Begin utility canvas imports, like clearRectFull

/// Performs full clear on context.
extern "0" fn @"36"(context_id: ContextId) void;

pub inline fn createCanvas(width: f64, height: f64) CanvasRenderingContext2D {
...
pub inline fn canvasBySvg(svg: []const u8, width: f64, height: f64) CanvasRenderingContext2D {
    const context_id = @"2"(svg.ptr, svg.len, width, height);
