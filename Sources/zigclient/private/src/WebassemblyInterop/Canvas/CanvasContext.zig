...
extern "0" fn @"1"(pointer: [*]const u8, length: u32, alpha: u8) Id;
/// Draw svg on context.
extern "0" fn @"2"(id: Id, pointer: [*]const u8, length: u32) void;
...
extern "0" fn @"31"(id: Id, x: f32, y: f32, radius: f32, startAngle: f32, endAngle: f32, counterclockwise: u8) void;
/// Performs ellipse on context.
extern "0" fn @"32"(id: Id, x: f32, y: f32, radiusX: f32, radiusY: f32, rotation: f32, startAngle: f32, endAngle: f32, counterclockwise: u8) void;
...
extern "0" fn @"37"(id: Id, pointer: [*]const u8, length: u32, x: f32, y: f32) void;
/// Performs strokeText to context.
extern "0" fn @"38"(id: Id, pointer: [*]const u8, length: u32, x: f32, y: f32) void;
...
extern "0" fn @"41"(id: Id, pointer: [*]const u8, length: u32) void;
...
pub inline fn getCanvasContextFromElement(comptime element_id: []const u8, comptime alpha: bool) CanvasContext {
    const id = @"1"(element_id.ptr, element_id.len, comptime @intFromBool(alpha));
