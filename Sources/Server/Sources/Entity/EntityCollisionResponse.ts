...
import EllipseCollider2D, { type Ellipse } from "../Utils/EllipseCollider2D";
      ...
      if (this instanceof Mob) {
        ...
        nearby.forEach(_otherEntity => {
          ...
          if (otherEntity instanceof Mob) {
            ...
            const delta = EllipseCollider2D.computeDelta(ellipse1, ellipse2);

            if (EllipseCollider2D.isColliding(delta)) {
