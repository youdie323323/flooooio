...
class MobRendererSandstorm extends MobRenderer_1.default {
    render(context) {
        ...
        const i = isSpecimen
            ? 0
            : entity.totalT * 5;
        const outerColor = this.toEffectedColor(context, (entity.isPet ? "#d4a6a7" : "#e9d683"));
        const middleColor = this.toEffectedColor(context, (entity.isPet ? "#bd9495" : "#e0c156"));
        const innerColor = this.toEffectedColor(context, (entity.isPet ? "#a88485" : "#d2b130"));
        ctx.lineJoin = "round";
        ctx.lineWidth = 6;
        {
            ctx.save();
...
exports.default = MobRendererSandstorm;
