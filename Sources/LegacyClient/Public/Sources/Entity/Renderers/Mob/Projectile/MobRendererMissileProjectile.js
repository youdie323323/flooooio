...
exports.missileBodyStroke = exports.missileBody = void 0;
const MobRenderer_1 = __importDefault(require("../MobRenderer"));
exports.missileBody = (function () {
...
exports.missileBodyStroke = (function () {
    const path = new Path2D();
...
class MobRendererMissileProjectile extends MobRenderer_1.default {
    render(context) {
        ...
        ctx.fill(exports.missileBody, "nonzero");
        ctx.fill(exports.missileBodyStroke, "nonzero");
    }
}
exports.default = MobRendererMissileProjectile;
