...
const PlayerRenderer_1 = __importDefault(require("./PlayerRenderer"));
const TAU = 2 * Math.PI;
class PlayerRendererNormal extends PlayerRenderer_1.default {
    render(context) {
        // Non-recursive renderer
        // super.render(context);
        const { ctx, entity } = context;
        const { eyeX, eyeY, isDead, sadT, angryT, } = entity;
        ctx.lineCap = "round";
        { // Normal body
            ctx.beginPath();
    ...
    drawEyeShape({ ctx }, centerX, centerY, widthRadius, heightRadius, angerOffset, flag = 0) {
...
exports.default = PlayerRendererNormal;
