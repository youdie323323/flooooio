...
import { ws } from "../../main";
import { Biomes, PetalType } from "../../../shared/enum";
...
export default class UserInterfaceMenu extends UserInterface {
    ...
    protected initializeComponents(): void {
        ...
        const readyButton = new ComponentTextButton(
            ...
            "#1dd129",
            async () => {
                ws.send(new Uint8Array([ServerBound.WAVE_ROOM_CHANGE_READY, true ? 1 : 0]));
            },
            "Ready"
        );
        ...
        const joinPublicSquadButton = new ComponentTextButton(
            ...
            "#1dd129",
            async () => {
                ws.send(new Uint8Array([ServerBound.WAVE_ROOM_JOIN_PUBLIC, Biomes.DESERT]));
            },
            "Join public squad"
        );
        ...
        const createPublicButton = new ComponentTextButton(
            ...
            "#1dd129",
            async () => {
                ws.send(new Uint8Array([ServerBound.WAVE_ROOM_CREATE, Biomes.DESERT]));
            },
            "Create public"
        );
        ...
        const setPublicButton = new ComponentTextButton(
            ...
            "#1dd129",
            async () => {
                ws.send(new Uint8Array([ServerBound.WAVE_ROOM_CHANGE_VISIBLE, 1]));
            },
            "Set public"
        );
        ...
        const setPrivateButton = new ComponentTextButton(
            ...
            "#1dd129",
            async () => {
                ws.send(new Uint8Array([ServerBound.WAVE_ROOM_CHANGE_VISIBLE, 0]));
            },
            "Set private"
        );
