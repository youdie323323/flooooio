...
(function loop() {
...

    {
        ...
        const sinMoveCounter = Math.sin(moveCounter * 1.6) * 0.1;
...

    {
        ...
        { // Legs
            ...
            for (let i = 0; i < 8; i++) {
                let dir = (0.25 + i % 4 / 3 * 0.4) * Math.PI + Math.sin(i + moveCounter * 1.3) * 0.2;
                if (i >= 4) {
                    dir *= -1;
                }
...

    {
        ...
        ctx.fillStyle = "#DBAB32";
        ctx.fill(scorpionTail, "nonzero");

        ctx.fillStyle = "#B18B28";
